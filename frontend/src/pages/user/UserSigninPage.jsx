...
const UserSigninPage = () => {
  ...
  return (
    <Box className="min-h-screen flex flex-col bg-gray-100"> {/* Entire screen container */}
      ...
      <HStack justifyContent="space-between" w="full" p="4" bg="gray.200">
        ...
        {/* Back Icon - Redirect to the previous page */}
        <Box>
          <IconButton
            aria-label="Go Back"
            icon={<ArrowBackIcon />}
      ...
      {/* Sign-In Form Section (centered vertically) */}
